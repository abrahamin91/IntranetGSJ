<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Capacitaciones.aspx.cs" Inherits="SignalRTest.ComunikSJ.Capacitaciones" %>
...
<body>
    <form id="form1" runat="server">
        <table style="width: 100%">
            <tr>
                <td>
                    <img src="../Imagenes IntranetSJ/logo_capacitaciones_comunik.jpg" border="0" height="120" style="width: 100%"></td>
            </tr>
        </table>
     <div class="cart">
            <div id="sidebar">
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 40%">
                    <img src="../Imagenes IntranetSJ/CapacitacionesOct.png" border="0" style="width: 800px; height: 900px;" /></td>
                <td style="width: 30%"></td>
            </tr>
        </table>
