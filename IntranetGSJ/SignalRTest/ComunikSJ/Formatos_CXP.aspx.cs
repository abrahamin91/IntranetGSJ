...
{
    public partial class Formatos_CXP : System.Web.UI.Page
    {
        ...
        {
            DataSet Formatoss = SignalRTest.Database.General.Monitoreo.Cargar_Formatos("Cargar_FormatosCxP");
        ...
        protected void listarFormatos()
        {
            ...
            Formatoss = SignalRTest.Database.General.Monitoreo.Cargar_Formatos("Cargar_FormatosCxP");
            Formatos_CporP.DataSource = dt;
            Formatos_CporP.DataBind();
        }
