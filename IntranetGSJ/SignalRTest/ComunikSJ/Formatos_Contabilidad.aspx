<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Formatos_Contabilidad.aspx.cs" Inherits="SignalRTest.ComunikSJ.Formatos_Contabilidad" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Formatos Contabilidad</title>
    ...
    <form id="form_rh" runat="server">
     ...
     <div class="cart">
        ...
        <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <asp:Label ID="Label2_m" runat="server" Text="Contabilidad" Font-Size="20px" Style="width: 100%" ForeColor="#cc0000" Font-Bold="true"></asp:Label>
                        </div>
                    </td>
                    <td>
          ...
          <asp:GridView ID="Formatos_Conta" HeaderStyle-BackColor="#000000" HeaderStyle-ForeColor="White"
                        runat="server" AutoGenerateColumns="False" CssClass="table table-bordered"
                        DataKeyNames="Numero" ForeColor="#333333" 
                    Width="100%" onselectedindexchanging="Formatos_Contabilidad_SelectedIndexChanging"  Height="90px">                   
            <Columns>
