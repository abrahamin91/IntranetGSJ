<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cursos_para_ti.aspx.cs" Inherits="SignalRTest.ComunikSJ.Cursos_para_ti" %>
...
<body>
    <form id="form1" runat="server">
        <table style="width: 100%">
            <tr>
                <td>
                    <img src="../Imagenes IntranetSJ/logo_cursos_para_ti_comunik.jpg" border="0" height="120" style="width: 100%"></td>
            </tr>
        </table>
    <div class="cart">
            <div id="sidebar">
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 40%">
                    <img src="../Imagenes IntranetSJ/concluye_tus_estudios.jpg" border="0" style="height: 480px;" />
                </td>
                <td style="width: 20%">
                    &nbsp
                </td>
