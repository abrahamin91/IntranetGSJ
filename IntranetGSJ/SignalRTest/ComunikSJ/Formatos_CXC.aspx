<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Formatos_CXC.aspx.cs" Inherits="SignalRTest.ComunikSJ.Formatos_CXC" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Formatos Cuentas por Cobrar</title>
     ...
     <div class="cart">
        ...
        <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <asp:Label ID="Label2_m" runat="server" Text="Cuentas por Cobrar" Font-Size="20px" Style="width: 100%" ForeColor="#cc0000" Font-Bold="true"></asp:Label>
                        </div>
                    </td>
                    <td>
          ...
          <asp:GridView ID="Formatos_CporP" HeaderStyle-BackColor="#000000" HeaderStyle-ForeColor="White"
                    ...
                    Width="100%"  onselectedindexchanging="Formatos_CporP_SelectedIndexChanging"  Height="90px">
