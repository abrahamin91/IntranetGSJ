<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Calendario.aspx.cs" Inherits="SignalRTest.ComunikSJ.Calendario" %>
...
<body>
    <form id="form1" runat="server">
        <table style="width: 100%">
            <tr>
                <td>
                    <img src="../Imagenes IntranetSJ/logo_calendario_comunik.jpg" border="0" height="120" style="width: 100%"></td>
            </tr>
        </table>
        <div class="cart">
            <div id="sidebar">
        ...
        <table style="width: 100%">
            <tr>
                   ...
                   <td style="width:30px"></td><td><asp:Calendar ID="Calendar" runat="server" SelectionMode="DayWeekMonth" DayStyle-Height="70px" BackColor="Black" BorderColor="White" BorderWidth="1px" Font-Names="Book Antiqua" Font-Size="16pt" ForeColor="White" Height="190px" NextPrevFormat="FullMonth" Width="100%">

                        <NextPrevStyle Font-Bold="True" Font-Size="12pt" ForeColor="red" VerticalAlign="Bottom" />
                        <OtherMonthDayStyle ForeColor="#999999" />

                        <SelectedDayStyle BackColor="Wheat"
                            ForeColor="Red"></SelectedDayStyle>

                        <DayHeaderStyle Font-Bold="True" Font-Size="16pt" />

                        <DayStyle Height="70px" />

                        <TitleStyle BackColor="black" BorderColor="Black" BorderWidth="0px" Font-Bold="True" Font-Size="18pt" ForeColor="red" />
                        <TodayDayStyle BackColor="Wheat" />
