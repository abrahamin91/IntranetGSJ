<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Calendar.aspx.cs" Inherits="SignalRTest.descarga_info.Calendar" %>
...
<body>
    ...
    <asp:TextBox
        id="txtEventDate"
        Runat="server" />
    <img src="../images/calendar.png" Height="30px" Width="30px" onclick="displayCalendar()" />
